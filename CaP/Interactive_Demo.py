...
from CaP.prompt_swarm_robot import task_name

print(sys.executable)

with open('../config/config2.yaml', 'r') as file:
    config = yaml.safe_load(file)
    openai_base =  'https://vip.dmxapi.com/v1'
...
class LMP:
    ...
    def __call__(self, query, context='', **kwargs):
        #  query是user requirement，context是环境的情况
...
from swarm_prompt.prompt_swarm_robot import UserRequirement
